...
const styles = StyleSheet.create({
  ...
  overrideLink: { color: theme.colors.primary, fontFamily: theme.font.semiBold, fontSize: 13 },
  ...
  timeButtonLabel: { color: theme.colors.textFaint, fontSize: 11, fontFamily: theme.font.semiBold },
  timeButtonValue: { color: theme.colors.text, fontSize: 15, fontFamily: theme.font.bold },
  overrideSaveButton: {
  ...
  overrideSaveButtonText: { color: theme.colors.primaryText, fontFamily: theme.font.bold },
  overrideResetText: { color: theme.colors.danger, fontSize: 12, fontFamily: theme.font.semiBold, textAlign: "center" },
  secondaryButton: { paddingVertical: theme.spacing.sm, alignItems: "center" },
  secondaryButtonText: { color: theme.colors.primary, fontFamily: theme.font.semiBold },
  removeButton: { paddingVertical: theme.spacing.sm, alignItems: "center" },
  removeButtonText: { color: theme.colors.danger, fontFamily: theme.font.semiBold },
  closeButton: {
  ...
  closeButtonText: { color: theme.colors.text, fontFamily: theme.font.semiBold },
});
